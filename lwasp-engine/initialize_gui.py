...
class MyWindow(Gtk.Window):
    ...
    def general_setup(self):
        ...
        self.email_smtp_server_entry = Gtk.Entry("SMTP Server (e.g. smtp.gmail.com)")
        self.email_box.pack_start(self.email_smtp_server_entry, False, False, 0)
        self.email_smtp_username_entry = Gtk.Entry("SMTP Username (e.g. example@gmail.com)")
        self.email_box.pack_start(self.email_smtp_username_entry, False, False, 0)
        self.email_smtp_password_entry = Gtk.Entry("SMTP Password")
    ...
    def next_button_pressed(self, button):
        ...
        if self.email_button.get_active():
            ...
            check_dialog.action_area.pack_start(recieved_button, False, False, 0)
