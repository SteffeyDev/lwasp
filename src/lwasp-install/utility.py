...
def sendScoringReport():
    ...
    message += '<br>Generated by LWASP, the Linux Watchful Adaptable Security Profiler<br>Built by Peter Steffey<br>Email <a href="mailto:steffeydev@icloud.com">steffeydev@icloud.com</a> with questions, comments, and suggestions'
