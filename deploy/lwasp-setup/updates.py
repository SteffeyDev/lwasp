...
class UpdatesBox(Gtk.ScrolledWindow):
    ...
    def check_button_clicked(self, button):
        ...
        elif i == 1: add(w.elements, "Auto-download Security Updates Enabled,V,7,FileContents,/etc/apt/apt.conf.d/10periodic,APT::Periodic::Download-Upgradeable-Packages \"1\"")
        elif i == 2: add(w.elements, "Check for Updates Daily Enabled,V,7,FileContents,/etc/apt/apt.conf.d/10periodic,APT::Periodic::Update-Package-Lists \"7\"")
