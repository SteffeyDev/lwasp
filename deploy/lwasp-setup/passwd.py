...
class PasswdBox(Gtk.ScrolledWindow):
    def __init__(self):
        ...
        for i in range(0,9):
            ...
            elif i == 7: label = "Score for Setting Password Complexity Requironmnets"
    ...
    def check_button_clicked(self, button):
        ...
        if i == 0: add(w.elements, "Created a password history file,V,6,FileExistance,/etc/security/opasswd,TRUE")
